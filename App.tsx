...
import { analyzeChart, runSimulation } from './services/geminiService';
import FileUpload from './components/FileUpload';
import ScenarioPanel from './components/ScenarioPanel';
import GhostChart from './components/GhostChart';
import HistoryDrawer from './components/HistoryDrawer';
import BacktestModal from './components/BacktestModal';
import { Crosshair, AlertOctagon, Terminal, Cpu, ScanEye, ArrowRight, Radio, Save, Clock, Share2, Check, BarChart3 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  // MarketData is currently unused in the "No Search Bar" version, kept for type compatibility or future re-enablement
  ...
  const handleSaveSimulation = () => {
    ...
    const newSave: SavedSimulation = {
      ...
      timestamp: Date.now(),
      ticker: undefined, // Ticker is no longer explicitly tracked
...
generated by Chart Wargame
  ...
  const handleSimulate = async (scenario: string) => {
    ...
    try {
      // Direct Oracle call without explicit news fetching
      const simResult = await runSimulation(image, analysis, scenario, undefined);
                 ...
                 {analysis && (
                   <div className="border-l-2 border-radar-green pl-3">
                     <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-radar-green uppercase text-xs font-bold">OBSERVER REPORT</span>
                     </div>
               ...
               <div className="absolute inset-0 flex items-center justify-center flex-col text-gray-700">
                 ...
                 <p className="font-mono text-sm">
                    {appState === AppState.CHART_READY 
                      ...
                      : (appState === AppState.ANALYZING_CHART ? "SCANNING TARGET..." : "NO DATA")}
                 </p>
               </div>
             )}
          </div>
